...
class Mesh:
    ...
    def __str__(self):
        return str(f'Результат - {self.mesh}')

    def __sub__(self, other):
        return self.mesh - other.mesh if (self.mesh - other.mesh) > 0 else print('Отрицательно!')

    def __mul__(self, other):
        return Mesh(self.mesh * other.mesh)

    def __truediv__(self, other):
        return Mesh(self.mesh // other.mesh)

    def __add__(self, other):
        return Mesh(abs(self.mesh + other.mesh))
